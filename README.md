...
## Output :
![Uploading Screenshot 2026-08-25 153029.png…]()


## Result : 
  The performance measures of a multiple server queuing model(M/M/c) with infintie capacity were succesfully calculated and evaluated using python.
